...
const DICT = {
  en: {
    ...
    'btn.loadCategories': 'List categories',
    'label.category': 'Category',
    'label.firstAiredAt': 'First aired at',
    'label.publishStatus': 'Publish status',
    'label.publishedAt': 'Publish at',
    'note.publishedAt': '(required for scheduled — when it goes live)',
    'label.coverImage': 'Cover image',
    'note.coverImage': '(optional — uploaded to the media library, then attached)',
    'opt.serverDefault': '— default (draft) —',
    'note.category': '(optional — the video-category termId)',
    'opt.keep': '— keep current —',
    'opt.unlink': '— none (clear) —',
    'terms.title': 'Category term ids',
    'terms.desc': 'The termIds of the video-category field. Public endpoint \u2014 only the CMS base URL above is used, no credentials.',
    'btn.loading': 'Loading…',
    'label.title': 'Title',
    ...
    'log.loadedTerms': (n) => `Loaded ${n} terms`,
  },
  th: {
    'app.title': 'Thai PBS Video CMS — Video Upload SDK',
    ...
    'btn.loadCategories': 'แสดงหมวดหมู่',
    'label.category': 'หมวดหมู่',
    'label.firstAiredAt': 'ออกอากาศครั้งแรก',
    'label.publishStatus': 'สถานะการเผยแพร่',
    'label.publishedAt': 'เผยแพร่เมื่อ',
    'note.publishedAt': '(จำเป็นสำหรับ scheduled — เวลาที่จะเผยแพร่)',
    'label.coverImage': 'ภาพปก',
    'note.coverImage': '(ไม่บังคับ — อัปโหลดเข้าคลังสื่อแล้วแนบให้)',
    'opt.serverDefault': '— ค่าเริ่มต้น (ฉบับร่าง) —',
    'note.category': '(ไม่บังคับ — termId ของ video-category)',
    'opt.keep': '— ใช้ค่าเดิม —',
    'opt.unlink': '— ไม่ระบุ (ล้างค่า) —',
    'terms.title': 'termId ของหมวดหมู่',
    'terms.desc': 'termId ของฟิลด์ video-category ใช้ endpoint สาธารณะ — ใช้แค่ CMS base URL ด้านบน ไม่ต้องใช้คีย์',
    ...
    'log.loadedTerms': (n) => `โหลด ${n} เทอมแล้ว`,
  },
};
