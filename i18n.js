...
const DICT = {
  en: {
    'app.title': 'CMS-Two Video Upload SDK',
    'app.subtitle': 'Upload videos into CMS-Two from your own app — one class, no dependencies.',
    ...
    'hint.preview': 'The CMS-Two player appears here once the video is ready.',
    'section.log': 'Log',
    'log.ready': 'Ready.',
    ...
    'doc.prereq.item2': 'Your CMS-Two team ID (teamId).',
    'doc.prereq.item3': 'The CMS-Two base URL — plus the API secret (env API_SERVER_SECRET) when not on local dev.',
  ...
  th: {
    'app.title': 'CMS-Two Video Upload SDK',
    'app.subtitle': 'อัปโหลดวิดีโอเข้า CMS-Two จากแอปของคุณ — คลาสเดียว ไม่มี dependency',
    ...
    'hint.preview': 'เพลเยอร์ CMS-Two จะแสดงที่นี่เมื่อวิดีโอพร้อม',
    'section.log': 'บันทึก',
    ...
    'doc.prereq.item2': 'Team ID ของทีมใน CMS-Two (teamId)',
    'doc.prereq.item3': 'Base URL ของ CMS-Two — และ API secret (env API_SERVER_SECRET) เมื่อไม่ได้ใช้เครื่อง local',
